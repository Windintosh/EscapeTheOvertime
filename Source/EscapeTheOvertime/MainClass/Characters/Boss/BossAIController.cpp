...
#include "Perception/AISense_Hearing.h" // [NEW] 청각 센스 헤더
...
{
	PrimaryActorTick.bCanEverTick = true; // 디버깅용 외엔 false 권장
	...
	SightConfig->SightRadius = 1500.0f; // 감지 반경 늘림 (기존 600은 너무 짧음)
	...
	// 3. [NEW] 청각 설정 (Hearing) - PawnSensing 대체
