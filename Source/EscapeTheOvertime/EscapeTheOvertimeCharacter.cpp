...
void AEscapeTheOvertimeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AEscapeTheOvertimeCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AEscapeTheOvertimeCharacter::Look);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AEscapeTheOvertimeCharacter::Look);
	}
	else
	{
...
void AEscapeTheOvertimeCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AEscapeTheOvertimeCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AEscapeTheOvertimeCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
